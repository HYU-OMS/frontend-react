...
class ManageMenu extends React.Component {
  ...
  handleNewMenuSubmit = (e) => {
    ...
    const url = this.props.api_url + "/v1/menu";
    const headers = {
  ...
  handleOnBlur = (menuItem) => {
    const url = this.props.api_url + "/v1/menu/" + (menuItem.id).toString();
    const headers = {
      "Authorization": "Bearer " + this.props.jwt
    };
      ...
      <React.Fragment>
        ...
        <Paper className={classes.root}>
          ...
          <FormControl fullWidth className={classes.formField}>
            ...
            <Button fullWidth color="primary" variant="contained" onClick={this.handleNewMenuSubmit}>추가하기</Button>
          </FormControl>
        </Paper>
      </React.Fragment>
    );
